...
class MasterAgent:
    ...
    def analyze_intent(self, user_prompt: str, current_alert: Dict = None) -> Dict[str, Any]:
        """Prompt-anchored subject selection with global defaults policy"""
        import re
        import json
        ...
        if 'summary only' in prompt_lower:
            ...
            if 'ip' in primary_subjects and not exclude_ip:
                ...
                if exclude_ip:
                    ...
                    reasons['ip_agent'] = "excluded: no IP subject in prompt"
            ...
            if 'user' in primary_subjects and not exclude_user:
                ...
                if exclude_user:
                    ...
                    reasons['user_context'] = "excluded: no user subject in prompt"
