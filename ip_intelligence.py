...
class IPAgent:
    ...
    def generate_ip_queries(self, ip_context: Dict, analysis_categories: List[str], analysis_prompt: str) -> List[Dict]:
        ...
        for category in analysis_categories:
            if category == 'traffic_analysis':
                ...
                queries.append({
                    'name': f'communication_{primary_ip}',
                ...
                queries.append({
                    'name': f'temporal_patterns_{primary_ip}',
                ...
                queries.append({
                    'name': f'security_indicators_{primary_ip}',
    ...
    def analyze_ip(self, alert: Dict, data_entry: Dict, analysis_prompt: str) -> Dict[str, Any]:
        """Main function: Complete IP context analysis"""
        
        # Extract IP context dynamically
        ...
        # Determine risk
        risk_level = self.determine_ip_risk(analysis['risk_score'])
